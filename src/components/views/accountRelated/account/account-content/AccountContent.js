...
const AccountContent = ({mod, user}) => {
    ...
    return (
        <div className='account-content-wrapper'>
            <div className="left">
                <h5>{t('welcome-message')} {user.firstName}</h5>
                <div className="left-item" 
                onClick={() => setIndex(1)} 
                style={{backgroundColor: index === 1 && '#0000001a'}}>
                ...
                <div className="left-item" 
                onClick={() => setIndex(2)}
                style={{backgroundColor: index === 2 && '#0000001a'}}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
                ...
                <div className="left-item" 
                onClick={() => setIndex(3)}
                style={{backgroundColor: index === 3 && '#0000001a'}}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
            ...
            <div className="right">
                ...
                {index === 3 && <Orders username={user.username} />}
            </div>
        </div>
    )
}
