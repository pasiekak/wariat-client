...
const FirstLastNameProperty = ({
  ...
  const onSubmit = (data) => {
    accountActions.personalData
      .updateFirstLastName(data.firstName, data.lastName)
      .then((res) => {
        if (res.data.success) {
          updateContextFunction("personalData", {
