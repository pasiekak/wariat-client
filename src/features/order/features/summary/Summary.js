...
const Summary = () => {
  ...
  return (
    <div
      className="Summary bck-smooth"
      style={{
        justifyContent: !order && "center",
        alignItems: !order && "center",
      }}
    >
      {!order ? (
        <Spinner />
        ...
        <>
          ...
          <div className="summary-wrapper">
            <h3 id="order-number">
              {t("order-number")}: <span id="order-id">#{order.id}</span>
            </h3>
              ...
              <div className="left">
                <section>
                  <ProductSummaryTable
                    ...
                    withDiscountPrices={order.discount.id !== 1}
                  />
                </section>
                <section>
