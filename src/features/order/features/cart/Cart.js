          ...
          <div className="cart-actions">
            {getCartCount() === 0 && (
              <div className="empty-cart-wrapper">
                <span id="empty-cart-message">
                  {t("empty-cart-button-disabled")}
                </span>
              </div>
            )}
              ...
              <div className="total-price-wrapper">
                <div className="total-normal">
                  ...
                  <span className="total">
                    {priceGetters.getProductsBrutto().toFixed(2)} zł
                  </span>
                </div>
                {priceGetters.getCartAfterGroupDiscount() ===
                  priceGetters.getProductsBrutto() && (
                  <div className="total-disc">
                    <span className="total-disc-message">
                      {t("total-disc")}:
                    </span>
                    <span className="total">
